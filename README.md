...
A lightweight, dependency-free restaurant frontend for Yousvv Restaurant in Sheikh Zayed City, Giza.

## Run

Open `index.html` directly in a browser. No install, backend, database, API key, or build step is required.
